...
${TESTDIR}/InterpreteurTest.o: InterpreteurTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/InterpreteurTest.o InterpreteurTest.cpp


${TESTDIR}/interpreteurTestRunner.o: interpreteurTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/interpreteurTestRunner.o interpreteurTestRunner.cpp
