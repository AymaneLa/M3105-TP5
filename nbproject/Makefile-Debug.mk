...
# Test Object Files
TESTOBJECTFILES= \
	${TESTDIR}/InterpreteurTest.o \
	${TESTDIR}/interpreteurTestRunner.o
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/InterpreteurTest.o ${TESTDIR}/interpreteurTestRunner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   `cppunit-config --libs`   


${TESTDIR}/InterpreteurTest.o: InterpreteurTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/InterpreteurTest.o InterpreteurTest.cpp


${TESTDIR}/interpreteurTestRunner.o: interpreteurTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/interpreteurTestRunner.o interpreteurTestRunner.cpp
